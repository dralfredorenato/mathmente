...
export const AGE_GROUPS = {
  crianca: {
    id: 'crianca', label: 'Crianca', range: '6-12 anos', icon: '🧒', fontScale: 1.0,
    defaults: {
      features: { financas: false, plantao: false, meditacao: false, medicamentos: true, exercicio: true, familia: true, estudos: true, rotina: true, pensamentos: true, oracao: true },
      educationLabel: 'Escola',
      studyProgramLabels: ['Escola', 'Reforco / Curso'],
    },
  },
  adolescente: {
    id: 'adolescente', label: 'Adolescente', range: '13-17 anos', icon: '🧑', fontScale: 1.0,
    defaults: {
      features: { financas: true, plantao: false, meditacao: true, medicamentos: true, exercicio: true, familia: true, estudos: true, rotina: true, pensamentos: true, oracao: true },
      educationLabel: 'Escola',
      studyProgramLabels: ['Escola', 'Curso Extra'],
    },
  },
  jovem: {
    id: 'jovem', label: 'Jovem Adulto', range: '18-29 anos', icon: '🧑‍🎓', fontScale: 1.0,
    defaults: {
      features: { financas: true, plantao: false, meditacao: true, medicamentos: true, exercicio: true, familia: true, estudos: true, rotina: true, pensamentos: true, oracao: true },
      educationLabel: 'Faculdade',
      studyProgramLabels: ['Faculdade', 'Curso Extra'],
    },
  },
  adulto: {
    id: 'adulto', label: 'Adulto', range: '30-59 anos', icon: '🧑‍💼', fontScale: 1.0,
    defaults: {
      features: { financas: true, plantao: false, meditacao: true, medicamentos: true, exercicio: true, familia: true, estudos: true, rotina: true, pensamentos: true, oracao: true },
      educationLabel: 'Pos-Graduacao',
      studyProgramLabels: ['Programa 1', 'Programa 2'],
    },
  },
  saude: {
    id: 'saude', label: 'Profissional de Saude', range: 'com plantoes', icon: '🏥', fontScale: 1.0,
    defaults: {
      features: { financas: true, plantao: true, meditacao: true, medicamentos: true, exercicio: true, familia: true, estudos: true, rotina: true, pensamentos: true, oracao: true },
      educationLabel: 'Pos-Graduacao',
      studyProgramLabels: ['Residencia', 'Pos-Graduacao'],
    },
  },
  idoso: {
    id: 'idoso', label: 'Idoso', range: '60+ anos', icon: '🧓', fontScale: 1.25,
    defaults: {
      features: { financas: true, plantao: false, meditacao: true, medicamentos: true, exercicio: true, familia: true, estudos: false, rotina: true, pensamentos: true, oracao: true },
      educationLabel: 'Cursos',
      studyProgramLabels: ['Curso 1', 'Curso 2'],
    },
  },
};

export const FONT_SCALES = {
  normal: { id: 'normal', label: 'Normal', value: 1.0 },
  grande: { id: 'grande', label: 'Grande', value: 1.15 },
  xgrande: { id: 'xgrande', label: 'Extra Grande', value: 1.3 },
};
...
export const DEFAULT_PROFILE = {
  ...
  ageGroup: 'adulto',
  fontScale: 'normal',
  features: AGE_GROUPS.adulto.defaults.features,
  studyProgramLabels: AGE_GROUPS.adulto.defaults.studyProgramLabels,
  educationLabel: AGE_GROUPS.adulto.defaults.educationLabel,
  onboarded: false,
};

export function useProfile() {
  return useLocalStorage('profile', DEFAULT_PROFILE);
}
